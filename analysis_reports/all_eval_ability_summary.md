...
| 2026_06_20_20_24_52_simlingo_base_seed_42_dinov2_l14_safety_v13_finetune_10ep_waypoint_speed_seed42_eval_bench2drive220/seed_42 | V5 waypoint-speed control ablation | DINOv2-L/14 | 2 | 1D speed waypoint + target speed head | Yes, K=16 motion tokens | Yes | waypoint-derived speed + route | 79.0542 | 100.00 | 0.7905 | 118 | 0.5293* | 0.4667 | 0.5000 | 0.6167 | 0.6000 | 0.4632 |

`*` Ability for the waypoint-speed control ablation is computed with the offline ability script variant: same scenario groups and infraction success rule as Bench2Drive, but without the CARLA junction-completion extra check used by official `ability_benchmark.py` for Traffic Signs.
